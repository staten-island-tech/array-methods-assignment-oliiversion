...
fruityflags.forEach((fruityflags) => {
  fruityflags.fruitylevel.forEach(fruityflags.fruitylevel) >
    console.log(fruityflags.fruitylevel);
});

console.log(fruityflags);

const result = fruityflags.filter(
  (fruityflags) => (fruityflags.colors = "blue+green+white")
);
console.log(result);
 */
